...
while r < 4:
    mini, maxi, avrg = process_numeric_field(my_list, r)
    print("Sepal Width: min={0}, max={1}, average={2}".format(str(mini), str(maxi), str(avrg)))
    r += 2

r = 3
while r < 4:
    mini, maxi, avrg = process_numeric_field(my_list, r)
    print("Petal Length: min={0}, max={1}, average={2}".format(str(mini), str(maxi), str(avrg)))
    r += 3

r = 4
while r < 5:
    mini, maxi, avrg = process_numeric_field(my_list, r)
    print("Petal Width: min={0}, max={1}, average={2}".format(str(mini), str(maxi), str(avrg)))
    r += 4

num_iris_setosa ,num_iris_versicolor ,num_iris_virginica = count_iris_types(my_list[-1])
print("Iris Types: Iris Setosa=" + str(num_iris_setosa) + ", Iris Versicolor=" + str(num_iris_versicolor) + ", Iris Virginica=" + str(num_iris_virginica))
